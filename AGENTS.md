...
- This repository is for QA Inflearn course notes.
- The user writes course notes directly under `class/`.
- Do not rewrite or reorganize files under `class/` unless the user explicitly asks.
